...
public class WeatherForecastService {
	...
	private static String URL_API_LOCATION_SEARCH_CITY = "http://servicos.cptec.inpe.br/XML/listaCidades?city=%s";
	...
	public static String citysearch(String city) throws IOException {
		String url = String.format(URL_API_LOCATION_SEARCH_CITY, city);
